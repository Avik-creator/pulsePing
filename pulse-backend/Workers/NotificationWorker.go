...
func NotificationWorker() {
	for {
		...
		tasks, err := redisClient.Client.BRPop(context.Background(), 0, "notification_queue").Result()
		if err != nil {
...
func sendToNotificationEmail(userEmail string, url string) error {
		...
		<table style="width: 100%%; max-width: 600px; margin: auto; background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
			<tr>
				<td style="text-align: center;">
					<h2 style="color: #d9534f;">🚨 Server Pulse Failure Alert 🚨</h2>
			...
			<tr>
				<td style="padding: 20px;">
					...
					<div style="text-align: center; margin-top: 20px;">
						<a href="https://pulseping.avikmukherjee.me" style="background-color: #5cb85c; color: white; padding: 12px 20px; border-radius: 5px; font-size: 16px; text-decoration: none;">
							Go to Dashboard
						</a>
					</div>
				</td>
			...
			<tr>
				<td style="padding: 20px; text-align: center;">
					<p style="font-size: 14px; color: #999;">
						If you have any questions, please <a href="mailto:avikm744@gmail.com" style="color: #337ab7;">contact support</a>.
					</p>
					<p style="font-size: 12px; color: #bbb;">&copy; %d pulseping.avikmukherjee.me  All rights reserved.</p>
				</td>
			</tr>
		</table>
	</div>
